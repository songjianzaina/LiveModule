...
import com.johnny.livelayout.R2;
...
public class LayerFragment extends Fragment {
     ...
     * 界面相关
     */
    @BindView(R2.id.llpicimage) LinearLayout llpicimage;
    @BindView(R2.id.rlsentimenttime) RelativeLayout rlsentimenttime;
    @BindView(R2.id.hlvaudience) HorizontalListView hlvaudience;
    @BindView(R2.id.lvmessage) ListView lvmessage;
    @BindView(R2.id.iv_privatechat) ImageView tvSendone;
    @BindView(R2.id.iv_gift) ImageView tvSendtwo;
    @BindView(R2.id.iv_share) ImageView tvSendthree;
    @BindView(R2.id.iv_close) ImageView tvSendfor;
    @BindView(R2.id.etInput) EditText etInput;
    @BindView(R2.id.iv_publicchat) ImageView tvChat;
    @BindView(R2.id.sendInput) TextView sendInput;
    @BindView(R2.id.llinputparent) LinearLayout llInputParent;
    @BindView(R2.id.giftRoot) GiftRootLayout giftRoot;
    ...
    @OnClick(R2.id.iv_publicchat) void clickChat(){
        showChat();
    }@OnClick(R2.id.sendInput) void clickSendChat(){
        sendText();
    }@OnClick(R2.id.iv_privatechat) void clickPrivateChat(){
    ...
    }@OnClick(R2.id.iv_gift) void clickGift(){
        GiftBean bean = new GiftBean();
        bean.setGroup(1);
        bean.setSortNum(22);
        bean.setGiftImage(R.mipmap.ic_launcher);
        ...
        bean.setUserAvatar(R.mipmap.ic_launcher);
        giftRoot.loadGift(bean);
    }@OnClick(R2.id.iv_share) void clickShare(){
        GiftBean bean = new GiftBean();
        bean.setGroup(1);
        bean.setSortNum(33);
        bean.setGiftImage(R.mipmap.ic_launcher);
        ...
        bean.setUserAvatar(R.mipmap.ic_launcher);
        giftRoot.loadGift(bean);
    }@OnClick(R2.id.iv_close) void clickClose(){
        getActivity().finish();
    }
